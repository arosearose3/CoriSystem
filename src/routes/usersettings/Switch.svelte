<script>
 ...
 import { createEventDispatcher } from 'svelte';
  ...
  export let value = 'No'; // Set default to 'No'

  let checked = value === 'Yes'; // Initialize checked based on value
  ...
  function handleClick(event) {
    checked = !checked;
    value = checked ? 'Yes' : 'No'; // Set value to 'Yes' or 'No' based on checked state
    dispatch('change', { value }); // Dispatch change event with the correct value
  }


</script>

<!-- <div class="s s--multi" style="font-size:{fontSize}px"> ignore font setting, inherit -->
<div class="s s--multi">
  <div
    role="radiogroup"
